var songs = [
    ...
    duration: "3:27", cover: 'linear-gradient(135deg, #ff1493, #c71585)', audioUrl: '/music/ddu-du-ddu-du.mp3'},
    ...
    duration: "3:03", cover: 'linear-gradient(135deg, #ff69b4, #ff1493)', audioUrl: '/music/how-you-like-that.mp3'},
    {title: "BOOMBAYAH", artist: "BLACKPINK", album: "SQUARE ONE", 
    duration: "4:04", cover: 'linear-gradient(135deg, #000000, #ff1493)', audioUrl: '/music/boombayah.mp3'},
    {title: "Whistle", artist: "BLACKPINK", album: "SQUARE ONE", 
    duration: "3:50", cover: 'linear-gradient(135deg, #ff1493, #ff69b4)', audioUrl: '/music/whistle.mp3'},
    {title: "Playing with Fire", artist: "BLACKPINK", album: "SQUARE TWO", 
    duration: "3:28", cover: 'linear-gradient(135deg, #c71585, #ff69b4)', audioUrl: '/music/playing-with-fire.mp3'},
    {title: "As If It's Your Last", artist: "BLACKPINK", album: "SINGLE", 
    duration: "3:36", cover: 'linear-gradient(135deg, #ff69b4, #000000)', audioUrl: '/music/as-if-its-your-last.mp3'},
    {title: "Stay", artist: "BLACKPINK", album: "SQUARE TWO", 
    duration: "4:01", cover: 'linear-gradient(135deg, #ff1493, #c71585)', audioUrl: '/music/stay.mp3'},
    {title: "Pink Venom", artist: "BLACKPINK", album: "BORN PINK", 
    duration: "3:13", cover: 'linear-gradient(135deg, #000000, #c71585)', audioUrl: '/music/pink-venom.mp3'},
    {title: "Shut Down", artist: "BLACKPINK", album: "BORN PINK", 
    duration: "3:00", cover: 'linear-gradient(135deg, #c71585, #ff1493)', audioUrl: '/music/shut-down.mp3'},
    {title: "Lovesick Girls", artist: "BLACKPINK", album: "THE ALBUM", 
    duration: "3:21", cover: 'linear-gradient(135deg, #ff69b4, #c71585)', audioUrl: '/music/lovesick-girls.mp3'},
    {title: "Ice Cream", artist: "BLACKPINK ft. Selena Gomez", album: "THE ALBUM", 
    duration: "3:02", cover: 'linear-gradient(135deg, #ff1493, #ff69b4)', audioUrl: '/music/ice-cream.mp3'},
    {title: "Forever Young", artist: "BLACKPINK", album: "SQUARE UP", 
    duration: "3:54", cover: 'linear-gradient(135deg, #ff1493, #000000)', audioUrl: '/music/forever-young.mp3'},
    {title: "Pretty Savage", artist: "BLACKPINK", album: "THE ALBUM", 
    duration: "3:24", cover: 'linear-gradient(135deg, #000000, #ff69b4)', audioUrl: '/music/pretty-savage.mp3'},
    {title: "The Girls", artist: "BLACKPINK", album: "BORN PINK", 
    duration: "2:43", cover: 'linear-gradient(135deg, #c71585, #ff69b4)', audioUrl: '/music/the-girls.mp3'},
    {title: "Jump", artist: "BLACKPINK", album: "JUMP", 
    duration: "3:13", cover: 'linear-gradient(135deg, #c71585, #ff69b4)', audioUrl: '/music/jump.mp3'},
    {title: "Flower", artist: "JISOO", album: "ME", 
    duration: "3:04", cover: 'linear-gradient(135deg, #ff1493, #000000)', audioUrl: '/music/flower.mp3'},
    {title: "Solo", artist: "JENNIE", album: "SOLO", 
    duration: "2:56", cover: 'linear-gradient(135deg, #000000, #c71585)', audioUrl: '/music/solo.mp3'},
    {title: "On Th Ground", artist: "ROSE", album: "R", 
    duration: "3:08", cover: 'linear-gradient(135deg, #ff69b4, #ff1493)', audioUrl: '/music/on-the-ground.mp3'},
    {title: "Money", artist: "LISA", album: "LALISA", 
    duration: "2:50", cover: 'linear-gradient(135deg, #ff69b4, #000000)', audioUrl: '/music/money.mp3'}
];
